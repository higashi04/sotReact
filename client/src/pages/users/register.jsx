...
import { FlashError } from "../../components/flash/Flash";
...
const Register = () => {
    ...
    const formSubmitHandler = e => {
        ...
        const errMessage = 'Se generó un error, favor de volver a intentarlo o solicitar apoyo.'
            ...
            if (!res.ok) {
                switch (res.status) {
                    ...
                    case 500:
                        ...
                        if (data.message) {
                            setError(data.message || errMessage)
                        }
                        break;
                    default:
                        setError(errMessage)
